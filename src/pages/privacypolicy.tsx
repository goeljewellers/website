...
const PrivacyPolicy = () => {
  return (
    <Layout>
      <SEO title="Page two" />
      <Box maxW="6xl" mx="auto" my={16} px={10}>
        <Heading lineHeight="taller">Privacy Policy</Heading>
        <Text lineHeight="taller">
          Your privacy is important to us. It is Goel Jewellers' policy to
          respect your privacy regarding any information we may collect from you
          across our website, https://www.goeljewellers.com, and other sites we
          own and operate.
          <br />
          <br />
